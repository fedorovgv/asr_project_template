...
class Serialization:
    """
    Base Class for all modules that allows to instantiate a class from a 
    DictConfig object.
    """
    @staticmethod
    def from_config(cfg: DictConfig, **kwargs) -> Any:
        """
        Each module initizializated by the part of the config file in .yaml 
        format. The structure must follow pattern:
            module:
                target_cls: abc.ABC
                kwarg1: value1
                kwarg2: value2
                ...
        Then an initialized copy of abc.ABC(kwarg1=value1, ...) will be 
        returned.
        """
