...
* implement an architecture for efficient parallel learning (using torch ddp or frameworks like horovod, deepspeed)
* ~~use `torchmetrcis` instead raw torch code~~
* add scripts for different dataset dowloading (ljspeech, mcv, etc.)
* add support for training in russian
